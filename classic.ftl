...
\address{${resume.contact.addressLine}}{${addressString} - ${resume.contact.pincode}}}
...
\cvitem{${position.startDateAndEndDate}}{\textbf{${position.title}}, ${position.companyName}}
...
\cvitem{${education.startDateAndEndDate}}{\textbf{${education.degree}}, ${education.fieldOfStudy}}
...
\cvitem{${project.startDateAndEndDate}}{\textbf{${project.name}}}}
...
\cvitem{${talk.date}}{\textit{${talk.title}} - ${talk.speakers}}
\cvitem{}{${talk.event}}
...
\cvitem{${publication.date}}{\textit{${publication.title}} - ${publication.authors}}
<#if helper.isNotEmpty("${publication.publisherName}")>
\cvitem{}{${publication.publisherName}}
</#if>
...
\cvitem{${patent.date}}{\textit{${patent.title}} - ${patent.inventors}}
...
\cvitem{${certification.startDateAndEndDate}}{\textit{${certification.name}} - ${certification.authorityName}}
<#if helper.isNotEmpty("${certification.number}")>
\cvitem{}{${certification.number}}
</#if>
\cvitem{}{}
</#list>
</#if>
...
\cvitem{${testScore.date}}{${testScore.score} - \textit{${testScore.name}}}
\cvitem{}{}
</#list>
</#if>
</#if>
