...
\colorlet{color1}{black!100}%  for section rule and vertical rule
...
\colorlet{color1}{blue!90}%  for section rule and vertical rule
...
\colorlet{color1}{green!60}%  for section rule and vertical rule
...
\colorlet{color1}{orange!50}%  for section rule and vertical rule
...
\colorlet{color1}{red!80}%  for section rule and vertical rule
...
\colorlet{color1}{purple!80}%  for section rule and vertical rule
...
\colorlet{color1}{grey!80}%  for section rule and vertical rule
