  ...
  \backgroundsetup{%
    ...
    contents={%
      \begin{tikzpicture}[remember picture, overlay]
        \node [anchor=west, text=color2,align=center, font=\addressfont] at ([xshift=-1cm]current page footer area.west) {powered by\\ \httplink{CVsIntellect.com}};
      \end{tikzpicture}},
  }%
%%
...
<#assign customSection = resume.getCustomSection("${sectionDetail.sectionId}")><#if customSection.hasCustomSectionEntries()>
\section{${sectionDetail.heading}}
